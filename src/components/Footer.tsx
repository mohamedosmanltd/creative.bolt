          ...
          <div className="md:col-span-2 lg:col-span-2">
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <div>
                  <div className="text-sm text-neutral-300" dir="ltr">+20 100 123 4567</div>
                  <div className="text-xs text-neutral-500" dir="ltr">+20 100 765 4321</div>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <Mail className="w-5 h-5 text-primary-400 mt-0.5 flex-shrink-0" />
                <a href="mailto:info@creative-realestate.com" className="text-sm text-neutral-300 hover:text-primary-400 transition-colors" dir="ltr">
                  info@creative-realestate.com
                </a>
              </li>
              <li className="flex items-start gap-3">
                <MapPin className="w-5 h-5 text-primary-400 mt-0.5 flex-shrink-0" />
                <span className="text-sm text-neutral-300">{t('contact.addressValue')}</span>
              </li>
            </ul>
          </div>
        </div>
